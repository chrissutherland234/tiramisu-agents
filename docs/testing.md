...
- 229 backend tests: 153 unit/contract cases, 72 PostgreSQL or Temporal integration cases, and 4 committed-history replay cases.
- 3 tests in the independently installable support client project, run from its own locked editable environment.
- 5 Vue component cases across 2 files covering the operator journey/review/intervention/dead-letter/model-budget surface, permission degradation, polling, and Wake authority wording.
