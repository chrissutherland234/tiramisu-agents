...
- `Scenario`: the happy path in language a business owner can review.
...
The deployment entry point is `support_client_pack:create_client_pack`. Replace
`StubActionAdapter` with a real messaging adapter before using this outside tests.
